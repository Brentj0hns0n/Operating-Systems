...
*   OS - Summer 2015                        *
*   7/17/2015                               *
*   Assignment 1 - Program 2 - Part 2       *
*                                           *
*   This C program is intended to set up    *
*   a child-to-parent pipe.  The child      *
*   executes to perform a "pre" process     *
*   whose output is connected to the parent *
*   which execute to perform sort process.  *
********************************************/
